...
# inputs
VBUKR= int(input('Enter value of VBUKR or else press enter key'))
# PSPID = input('Enter value PSPID or else press enter key')
POST1 = input('Enter value of POST1 or else press enter key')
# PLFAZ= input('Enter value of PLFAZ or else press enter key')
...
MANDT = input('Enter Environment_code or else press 0 for default 30')
ZZ_CLIENT = input('Enter value of ZZ_CLIENT or else press enter key')
...
if Number_of_Records != 0:
    ...
    try:
        ...
        for key, value in config_file.items():
            ...
            elif key.lower() == 'sdv_metadata'.lower():
                sdv_metadata = value.loc[:, :]
                #print(sdv_metadata)
            elif key.lower() == 'Data_dependency'.lower():
                Data_dependency_df = value.loc[:,:]
                print(Data_dependency_df)
            elif key.lower() == 'Pickle_file_locations'.lower():
        ...
        sdv_metadata_Rule_indicator_list = ['RL','MD','TXT','BD','DV','RLDP']
