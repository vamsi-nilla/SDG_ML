...
class Bulk_Driver():
    ...
    def bulk_driver_method(self,header,body_list):
        ...
        for j in body_list:
            ...
            if field_value == '':
                field_value = 0
            input_dictionary[j['FieldDesc']] = field_value

        Process_area_flag = input_dictionary['ProcessAreaId']

        Default_records_flag = input_dictionary['DefaultRecords']

        Current_date = input_dictionary['Start Date']

        Finished_date = input_dictionary['End Date']
        Number_of_Records = input_dictionary['NumOfRecords']
        VBUKR = input_dictionary['Entity']
        POST1 = input_dictionary['POST1']
        L2_levels = input_dictionary['L2_levels']
        MANDT = input_dictionary['MANDT']
